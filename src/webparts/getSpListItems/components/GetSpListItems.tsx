...
export default class GetSpListItems extends React.Component<IGetSpListItemsProps, IGetSpListItemsStates> {
  ...
  public async getData() {
    ...
    const items: any[] = await web.lists.getByTitle("FluentUITest").items.select("*", "CustomerName/EMail", "CustomerName/Title").expand("CustomerName/ID").get();
    console.log(items);
  ...
  public render(): React.ReactElement<IGetSpListItemsProps> {
    return (
      <div className={ styles.getSpListItems }>
